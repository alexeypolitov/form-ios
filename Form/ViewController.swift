...
class ViewController: UIViewController {
    ...
    func buildForm() throws {
        ...
        try formView +++ FormViewGroup("testGroup") { group in
            
            group.footer = FormViewHeaderFooterContainer() { container in
                
//                container.insets = UIEdgeInsets(top: 7, left: 15, bottom: 6, right: 14)
                container.control = ProductSpecCollectionView("preview") { collection in
                    collection.items = [
                        ProductSpecCollectionViewItem(title: "test", detail: "test"),
                        ProductSpecCollectionViewItem(title: "test", detail: "test")]
                }
